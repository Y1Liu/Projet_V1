from wtforms import TextField, TextAreaField, validators, StringField, SubmitField, RadioField, PasswordField, FieldList, SelectMultipleField
...
class RegisterForm(FlaskForm):
    ...
    register_password = PasswordField('password', validators=[InputRequired(), Length(min=1, max=100)])
