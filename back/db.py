...
#SOLUTEC Paris
#10/04/2018
#Les fonctions d'insertion dans la BDD sont encascad√©es selon les d√©pendances
###############################################################################
...
#Permet de r√©aliser une commande sql
...
#RÈcupÈration de toutes les places et instanciation de objets
def placesToCsv():
